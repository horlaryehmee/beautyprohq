                    ...
                    <div className="mb-5 grid gap-3 md:grid-cols-[1fr_auto]">
                        ...
                        <div className="flex rounded-2xl border border-slate-200 bg-white p-1">
                            {['all', 'active', 'hidden'].map((item) => (
                                <button
                                    className={`rounded-xl px-4 py-2 text-xs font-semibold uppercase tracking-wide transition ${status === item ? 'bg-slate-950 text-white' : 'text-slate-500 hover:bg-slate-50'}`}
                                    key={item}
                            ...
                            {filtered.map((service) => (
                                <div className="grid gap-4 bg-white p-4 transition hover:bg-slate-50/70 lg:grid-cols-[1fr_auto_auto]" key={service.id}>
                                    ...
                                    <div className="self-center text-left lg:text-right">
                                        <p className="text-lg font-semibold text-slate-950"><Currency currency={service.currency ?? 'NGN'} value={service.price} /></p>
                                    </div>
