...
const sections = [
    ...
    ['Users and account control', [
        'Users provides search, inspection and update access for admin, provider and customer accounts.',
        ...
        'Role changes affect dashboard routing, permissions and feature access, so role updates should be treated as account-level changes.',
    ]],
    ['Directory management', [
        'Directory should contain Directory list, Provider categories and Pro of the week areas.',
        'Directory list manages provider visibility and profile readiness. List format with pagination is used for easier backend review.',
        ...
        'Incomplete or inactive providers can be hidden from public directory results until their profile is ready.',
    ]],
    ['Provider verification', [
        ...
        'Rejection stores an admin note that explains what the provider must correct before resubmission.',
    ]],
    ['Content management', [
    ...
    ['Security settings', [
        ...
        'Integration credentials are stored in platform settings and consumed by backend services at runtime.',
    ]],
