                        ...
                        <div className="mt-5 space-y-4">
                            ...
                            <label className={`flex items-start gap-3 rounded-2xl border p-4 ${editing?.newsletter_notified_at ? 'border-amber-100 bg-amber-50' : 'border-slate-200 bg-slate-50'}`}>
                                ...
                                <span>
                                    ...
                                    <span className="mt-1 block text-xs leading-5 text-slate-500">Queues one concise email for each active newsletter subscriber. It will not queue the item twice.</span>
