        ...
        <article className={`group overflow-hidden rounded-lg border border-stone-200 bg-white text-[#241711] shadow-none transition duration-300 hover:-translate-y-0.5 sm:relative sm:border-0 sm:bg-[#34231c] sm:text-white sm:shadow-[0_16px_40px_rgba(45,29,22,.14)] sm:hover:-translate-y-1 sm:hover:shadow-[0_22px_55px_rgba(45,29,22,.18)] ${featured ? 'sm:min-h-[380px]' : 'sm:min-h-[330px]'}`}>
            <div className="grid h-[148px] grid-cols-[41%_1fr] sm:hidden">
                ...
                <div className="relative min-w-0 p-3">
                    <span className="absolute right-2.5 top-2.5 rounded-sm border border-[#241711]/30 p-1.5 text-[#241711]/80">
                    ...
                    <div className="min-w-0 pb-10 pr-8">
                        ...
                        <p className="mt-2 inline-flex items-center gap-1 text-[11px] font-black text-[#241711]">
                            <Icon name="star" size={12} fill="currentColor" strokeWidth={0} className="text-[#d39331]" />{pro.rating ? pro.rating.toFixed(1) : 'New'} {reviews ? `(${reviews})` : ''}
                        </p>
                    </div>
                ...
                <div className="mt-auto">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-3">
                        <span className="inline-flex items-center gap-1 text-xs font-black text-white">
                            <Icon name="star" size={13} fill="currentColor" strokeWidth={0} className="text-amber-400" />{pro.rating ? pro.rating.toFixed(1) : 'New'} {reviews ? `(${reviews})` : ''}
                        </span>
