            ...
            <main className="flex min-h-screen flex-col">
                ...
                <div className="flex flex-1 items-center justify-center px-5 py-8 sm:px-8 lg:py-12">
                    <div className="w-full max-w-[470px]">
                        <p className="mb-2 text-xs font-semibold uppercase tracking-[.18em] text-rose-600">{eyebrow}</p>
                        <h1 className="font-display text-3xl font-semibold leading-tight text-plum-950 sm:text-4xl">{title}</h1>
