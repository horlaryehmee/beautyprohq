...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{min-height:100%;background:#fdfbf8;color:#29131f;font-family:Inter,'Avenir Next','Segoe UI',system-ui,sans-serif}body{min-height:100vh;margin:0;overflow-x:hidden}
        ...
        .wrap{display:grid;min-height:100vh;width:min(1040px,calc(100% - 32px));margin:0 auto;padding:18px 0;grid-template-rows:auto auto auto;align-content:center;gap:18px}
        ...
        @media (max-width:820px){.image-marquees{position:relative;inset:auto;order:2;margin:-2px -16px 0;gap:10px}.copy{order:1}.panel{order:3}.image-row{gap:10px;animation-duration:30s}.image-row img{width:132px;height:78px}}
        @media (max-width:560px){.wrap{width:min(100% - 20px,1040px);padding:14px 0;gap:14px}.brand-bphq{font-size:1.55rem}.brand-name{font-size:7px;letter-spacing:.3em}main{display:flex;flex-direction:column;gap:12px;padding:0}.image-marquees{width:calc(100% + 20px);margin:0 -10px;gap:8px}.image-row{gap:8px;animation-duration:26s}.image-row img{width:116px;height:72px;border-radius:8px}.copy{padding-left:12px}.copy:before{width:2px}h1{font-size:34px;line-height:.98}.lead{margin-top:9px;font-size:14px;line-height:1.34}.panel{width:100%;padding:13px}.panel h2{font-size:22px}.panel p{font-size:13px;line-height:1.3}form{grid-template-columns:1fr;gap:8px;margin-top:10px}button{width:100%;min-height:40px}.marquee{padding:6px 0;font-size:9px;letter-spacing:.1em}footer{font-size:11px}}
