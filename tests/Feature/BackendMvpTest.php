...
class BackendMvpTest extends TestCase
{
    ...
    public function test_provider_can_manage_services_schedule_and_payment_account(): void
    {
        ...
        $this->putJson('/api/provider/payment-accounts', [
            ...
            'instructions' => 'Send proof of payment by WhatsApp.',
            'enabled' => true,
        ...
        $this->assertDatabaseHas('payment_accounts', ['provider_id' => $provider->id, 'gateway' => 'manual', 'enabled' => true, 'payment_instructions' => 'Send proof of payment by WhatsApp.']);
    }
